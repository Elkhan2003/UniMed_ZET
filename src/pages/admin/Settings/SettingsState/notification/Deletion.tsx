...
export const Deletion = ({ ByType, refetch, branchId }: any) => {
	...
	return (
		<div>
			<div className="p-4 flex items-center gap-2"></div>
			...
			<div className="flex flex-col gap-[10px] p-4">
				<p>Описание</p>
				<p>
					<span className="text-myviolet">{`{master_name}`}</span> - Имя Специалист
				</p>
				<p>
